...
# define BIND_FOUND	4	/* file found and time stamped */
	...
	timestamp_t	time;		/* update time - 0 if not exist */
} ;

static struct hash *bindhash = 0;
static void time_enter(char *, int, timestamp_t);
...
timestamp_t	*time;
{
	...
	*time = b->progress == BIND_FOUND ? b->time : TIME_ZERO;
}
