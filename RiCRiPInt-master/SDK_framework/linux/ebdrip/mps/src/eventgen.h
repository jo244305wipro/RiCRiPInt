 ...
 * This file was generated by eventgen.pl,v 1.17.1.1.1.1 2013/12/19 11:27:08 anon Exp
 */
...
#define EVENT_PAWP_FIELD_PTR(event, i) \
  (((i) == 0) ? (void *)&((event)->pawp.p0) \
   : ((i) == 1) ? (void *)&((event)->pawp.a1) \
   : ((i) == 2) ? (void *)&((event)->pawp.w2) \
   : ((i) == 3) ? (void *)&((event)->pawp.p3) \
   : NULL)
...
#define EVENT_PAWWW_FIELD_PTR(event, i) \
  (((i) == 0) ? (void *)&((event)->pawww.p0) \
   : ((i) == 1) ? (void *)&((event)->pawww.a1) \
   : ((i) == 2) ? (void *)&((event)->pawww.w2) \
   : ((i) == 3) ? (void *)&((event)->pawww.w3) \
   : ((i) == 4) ? (void *)&((event)->pawww.w4) \
   : NULL)
...
#define EVENT_PPAUU_FIELD_PTR(event, i) \
  (((i) == 0) ? (void *)&((event)->ppauu.p0) \
   : ((i) == 1) ? (void *)&((event)->ppauu.p1) \
   : ((i) == 2) ? (void *)&((event)->ppauu.a2) \
   : ((i) == 3) ? (void *)&((event)->ppauu.u3) \
   : ((i) == 4) ? (void *)&((event)->ppauu.u4) \
   : NULL)
...
#define EVENT_PPPWW_FIELD_PTR(event, i) \
  (((i) == 0) ? (void *)&((event)->pppww.p0) \
   : ((i) == 1) ? (void *)&((event)->pppww.p1) \
   : ((i) == 2) ? (void *)&((event)->pppww.p2) \
   : ((i) == 3) ? (void *)&((event)->pppww.w3) \
   : ((i) == 4) ? (void *)&((event)->pppww.w4) \
   : NULL)
...
typedef union {
  ...
  EventPAWPStruct pawp;
  EventPAWWWStruct pawww;
  EventPDDWWWStruct pddwww;
  EventPPStruct pp;
  EventPPAUStruct ppau;
  EventPPAUUStruct ppauu;
  EventPPAWPStruct ppawp;
  EventPPPStruct ppp;
  EventPPPAStruct pppa;
  EventPPPWWStruct pppww;
  EventPPUStruct ppu;
...
#define EVENT_PAWP(type, _p0, _a1, _w2, _p3) \
  EVENT_BEGIN(type) \
    EventMould.pawp.p0 = (_p0); \
    EventMould.pawp.a1 = (_a1); \
    EventMould.pawp.w2 = (_w2); \
    EventMould.pawp.p3 = (_p3); \
  EVENT_END(type, PAWP, sizeof(EventPAWPStruct))

#define EVENT_PAWWW(type, _p0, _a1, _w2, _w3, _w4) \
  EVENT_BEGIN(type) \
    EventMould.pawww.p0 = (_p0); \
    EventMould.pawww.a1 = (_a1); \
    EventMould.pawww.w2 = (_w2); \
    EventMould.pawww.w3 = (_w3); \
    EventMould.pawww.w4 = (_w4); \
  EVENT_END(type, PAWWW, sizeof(EventPAWWWStruct))
...
#define EVENT_PPAUU(type, _p0, _p1, _a2, _u3, _u4) \
  EVENT_BEGIN(type) \
    EventMould.ppauu.p0 = (_p0); \
    EventMould.ppauu.p1 = (_p1); \
    EventMould.ppauu.a2 = (_a2); \
    EventMould.ppauu.u3 = (_u3); \
    EventMould.ppauu.u4 = (_u4); \
  EVENT_END(type, PPAUU, sizeof(EventPPAUUStruct))
...
#define EVENT_PPPWW(type, _p0, _p1, _p2, _w3, _w4) \
  EVENT_BEGIN(type) \
    EventMould.pppww.p0 = (_p0); \
    EventMould.pppww.p1 = (_p1); \
    EventMould.pppww.p2 = (_p2); \
    EventMould.pppww.w3 = (_w3); \
    EventMould.pppww.w4 = (_w4); \
  EVENT_END(type, PPPWW, sizeof(EventPPPWWStruct))
...
#define EVENT_WS(type, _w0, _l1, _s1) \
  EVENT_BEGIN(type) \
    ...
    (void)mps_lib_memcpy(EventMould.ws.s1.str, _s1, _string_len); \
...
#define EventFormatPAWP 7
#define EventFormatPAWWW 8
#define EventFormatPDDWWW 9
#define EventFormatPP 10
#define EventFormatPPAU 11
#define EventFormatPPAUU 12
#define EventFormatPPAWP 13
#define EventFormatPPP 14
#define EventFormatPPPA 15
#define EventFormatPPPWW 16
#define EventFormatPPU 17
#define EventFormatPPUU 18
#define EventFormatPPUWWW 19
#define EventFormatPPWW 20
#define EventFormatPPWWW 21
#define EventFormatPPWWWUUU 22
#define EventFormatPW 23
#define EventFormatPWA 24
#define EventFormatPWAW 25
#define EventFormatPWP 26
#define EventFormatPWU 27
#define EventFormatPWW 28
#define EventFormatPWWWWDD 29
#define EventFormatPWWWWW 30
#define EventFormatPWWWWWWWWW 31
#define EventFormatPWWWWWWWWWWWW 32
#define EventFormatUUPA 33
#define EventFormatUUPP 34
