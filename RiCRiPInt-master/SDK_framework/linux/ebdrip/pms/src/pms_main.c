...
// for GPS_PRMINFO_GET_COLOR_MODEL - valid o/p are GPS_CM_BW_MACHINE, GPS_CM_FULL_COLOR_MACHINE, GPS_CM_TWIN_COLOR_MACHINE
// GG - SDK values are OIL_Mono, OIL_CMYK_Separations, OIL_CMYK_Composite, OIL_RGB_Separations, OIL_RGB_Composite, OIL_RGB_PixelInterleaved
  /*if(0 == GPS_PenvGetDefValue_1(GPS_PENV_NAME_COMMON, GPS_PRMINFO_GET_COLOR_MODEL, &gps_value)) // This is wrong
  {
    printf("GPS_PRMINFO_GET_COLOR_MODEL = %d \n",gps_value);
	g_tSystemInfo.eDefaultColMode = gps_value;
	switch()
	{
	case GPS_CM_BW_MACHINE:
	  g_tSystemInfo.eDefaultColMode = OIL_Mono;
	  break;
	case GPS_CM_FULL_COLOR_MACHINE:
	  g_tSystemInfo.eDefaultColMode = OIL_CMYK_Separations;
	  break;
	case GPS_CM_TWIN_COLOR_MACHINE:
	  g_tSystemInfo.eDefaultColMode = OIL_Mono;
	  break;
	default:
	  g_tSystemInfo.eDefaultColMode = OIL_CMYK_Separations;
...
//******Default values********** later replace values from gps**********
...
//******************end********************************
  ...
  {
    //g_tJob.tCurrentJobMedia.ePaperSize = gps_value;
	printf("ePaperSize = %d \n",gps_value);
  }
