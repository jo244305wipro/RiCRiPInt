...
# define 	T_BIND_EXISTS	3	/* real file, timestamp valid */
	...
	TARGETS	*deps[3];		/* dependencies */

# define	T_DEPS_DEPENDS	0	/* due to DEPENDS */
# define	T_DEPS_NIDEPENDS	1	/* due to NIDEPENDS */
# define	T_DEPS_INCLUDES	2	/* due to INCLUDES */

	timestamp_t	time;			/* update time */
	timestamp_t	leaf;			/* update time of leaf sources */
	timestamp_t	htime;			/* header's time */
	timestamp_t	hleaf;			/* update time of leaf headers */
